...
namespace HyperCard
{
    ...
    public class CardEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                CardSettings["Id"].intValue = EditorGUILayout.IntField("Collection #Id", Math.Max(1, CardSettings["Id"].intValue), GUILayout.ExpandWidth(false));
                GUILayout.Space(10);
            }
            ...
            if (GUICardEditor.DrawHeader("Card - FX"))
            {
                ...
                if (GUICardEditor.DrawHeader("Outline", 1))
                {
                    ...
                    CardSettings["OutlineStartColor"].colorValue = EditorGUILayout.ColorField(new GUIContent("Start Color"), CardSettings["OutlineStartColor"].colorValue, true, false, false);
                    CardSettings["OutlineEndColor"].colorValue = EditorGUILayout.ColorField(new GUIContent("End Color"), CardSettings["OutlineEndColor"].colorValue, true, false, false);
        ...
        private static void DrawCardSideLayout(string name, Color color, SerializedProperty side)
        {
            ...
            if (GUICardEditor.DrawHeader($"{name} settings", name, false, 0, color))
            {
                GUICardEditor.StartHeader();
        ...
        {
            var cards = (Card[])FindObjectsOfType(typeof(Card));
